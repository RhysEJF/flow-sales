...
Same as the stand-up: offer to pull and import the week's activity, link, plan, judge new batches with `flow-sales:deal-assessor` agents, and `fs.py rollup`. One line of progress.
